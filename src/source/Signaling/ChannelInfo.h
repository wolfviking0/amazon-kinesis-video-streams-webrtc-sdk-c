...
STATUS createChannelInfo(PCHAR, PCHAR, PCHAR, PCHAR, PCHAR, PCHAR, PCHAR, PCHAR, SIGNALING_CHANNEL_TYPE, SIGNALING_CHANNEL_ROLE_TYPE, BOOL, UINT64, BOOL, BOOL, UINT64, UINT32, PTag, PCHAR, PCHAR, PChannelInfo*);
